...
public class pass1 
{
    public static void main(String[] args) throws NullPointerException,FileNotFoundException
    {
       ...
       try
       {
        BufferedReader br=new BufferedReader(new FileReader("d:\\Java practice\\sample.txt"));
        BufferedWriter bw=new BufferedWriter(new FileWriter("d:\\Java practice\\Output.txt"));
    ...
    BufferedReader br=new BufferedReader(new FileReader("d:\\Java practice\\Output.txt"));
    System.out.println("\n***********************Output1.txt************************");
    try 
    {
